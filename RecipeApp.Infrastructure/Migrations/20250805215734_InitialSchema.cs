    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentHearts", x => new { x.UserId, x.CommentId });
                    table.ForeignKey(
                        name: "FK_CommentHearts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentHearts_Comments_CommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentHearts_CommentId",
                table: "CommentHearts",
                column: "CommentId");
